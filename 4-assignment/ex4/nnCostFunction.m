...
% The first row of h_theta belongs to the first training data, and the second row of h_theta belongs to the second training data and so on.

    temp1= -(yy .* log( h_theta(i,:)));

    temp2= (ones(1,num_labels) - yy) .* log(ones(1,num_labels) -  h_theta(i,:));
